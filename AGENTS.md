...
- **Coverage targets:** ViewModel 90%+ · UseCase 100% · Repository 90%+ · Mapper 100%. Aggregate CI floors are measured separately: lines 75% · branches 71%.
...
./gradlew koverVerify              # coverage baseline gate
```
